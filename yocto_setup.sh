...
sudo apt install -y gawk wget git diffstat unzip texinfo gcc build-essential chrpath socat cpio \
			...
			python3-subunit mesa-common-dev zstd liblz4-tool freetype* libx11-dev x11-xserver-utils \ 
			udev mesa-utils flac libogg-dev libvorbis-dev vorbis-tools libvorbisenc2 libvorbisfile3 \
